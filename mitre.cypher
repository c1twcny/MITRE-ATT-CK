...
MATCH (a17:Country {country: 'northKorean'}), (b17:Actor {name: 'APT37'}), (c17:Technique)
WHERE any(y17 IN c17.name WHERE y17 IN ['T1548','T1071','T1123','T1547','T1059','T1555','T1005','T1561','T1189','T1203','T1105','T1559','T1036','T1106','T1027','T1120','T1566','T1057','T1055','T1053','T1082','T1033','T1529','T1204','T1102'])
WITH b17, c17, a17
MERGE (b17)-[:EMPLOY]->(c17)
MERGE (a17)-[:SUPPORT]->(b17)

UNION

MATCH (a18:Country {country: 'northKorean'}), (b18:Actor {name: 'APT38'}), (c18:Technique)
WHERE any(y18 IN c18.name WHERE y18 IN ['T1071','T1217','T1110','T1115','T1059','T1543','T1485','T1486','T1005','T1565','T1561','T1189','T1083','T1562','T1070','T1105','T1056','T1112','T1106','T1135','T1027','T1588','T1566','T1057','T1053','T1505','T1518','T1218','T1082','T1049','T1033','T1569','T1529','T1204'])
WITH b18, c18, a18
MERGE (b18)-[:EMPLOY]->(c18)
MERGE (a18)-[:SUPPORT]->(b18)

UNION

MATCH (a19:Country {country: 'iran'}), (b19:Actor {name: 'APT39'}), (c19:Technique)
WHERE any(y19 IN c19.name WHERE y19 IN ['T1071','T1560','T1197','T1547','T1110','T1115','T1059','T1136','T1555','T1005','T1074','T1140','T1546','T1041','T1190','T1083','T1070','T1105','T1056','T1036','T1046','T1135','T1027','T1588','T1003','T1566','T1090','T1012','T1021','T1018','T1053','T1113','T1505','T1553','T1033','T1569','T1204','T1078','T1102'])
WITH b19, c19, a19
MERGE (b19)-[:EMPLOY]->(c19)
MERGE (a19)-[:SUPPORT]->(b19)

UNION

MATCH (a20:Country {country: 'china'}), (b20:Actor {name: 'APT41'}), (c20:Technique)
WHERE any(y20 IN c20.name WHERE y20 IN ['T1071','T1560','T1197','T1547','T1110','T1059','T1136','T1543','T1486','T1005','T1568','T1546','T1480','T1190','T1203','T1133','T1008','T1083','T1547','T1070','T1105','T1056','T1036','T1112','T1104','T1046','T1135','T1027','T1588','T1003','T1566','T1542','T1055','T1090','T1021','T1496','T1014','T1053','T1553','T1195','T1218','T1016','T1049','T1033','T1569','T1078','T1102','T1047'])
WITH b20, c20, a20
MERGE (b20)-[:EMPLOY]->(c20)
MERGE (a20)-[:SUPPORT]->(b20)